              ...
              <div className='absolute top-20 p-10'>
                <div className='flex flex-col items-center'>
                  ...
                  <p className='text-xl font-medium text-center'>
                    {user?.email} . Joined {new Date().toDateString()} . Visitor
                  </p>
                </div>
                {/* some user action  */}
                <div className='my-10 flex justify-center gap-5'>
                  ...
                  <button className='bg-[#796EFF] border-2 border-[#796EFF] text-white text-xl font-medium p-4 px-6 rounded-lg hover:bg-[#653DEE] active:bg-white active:text-[#653DEE] transition'>
                    Update Profile
                  </button>
                </div>
              </div>
