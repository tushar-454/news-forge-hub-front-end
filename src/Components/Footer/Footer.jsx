            ...
            <Container>
              ...
              <div className='grid gap-10 grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 py-10'>
                ...
                <div>
                  <Logo />
                  <p className='mt-3'>
                    Stay informed with our comprehensive coverage of breaking
                    news, insightful articles, and in-depth analysis across
                    various categories. Explore the latest updates in politics,
                    technology, entertainment, business, sports, and more. Our
                    mission is to deliver credible, timely, and diverse content
                    to keep you informed and engaged. Join us as we bring you
